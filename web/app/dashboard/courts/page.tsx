...
function CourtsContent() {
  ...
  const confirmBooking = async () => {
      ...
      toast.success("Booking Request Sent", {
          description: `Court: ${selectedCourt?.CourtName}, Time: ${timeSlotsLabels[selectedSlot!]}`,
          duration: 3000,
      });
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Dialog open={isBookingDetailsOpen} onOpenChange={setIsBookingDetailsOpen}>
            ...
            <DialogFooter className="mt-4 gap-2">
                ...
                <Button onClick={confirmBooking} className="h-11 bg-[#FA4616] hover:bg-[#d13a10] text-white font-bold px-6">
                    Confirm Booking
                </Button>
            </DialogFooter>
            </DialogContent>
